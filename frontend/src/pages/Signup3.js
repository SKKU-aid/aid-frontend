...
const Signup3 = () => {
  ...
  const handleOverallGPAChange = (e) => {
    const value = parseFloat(e.target.value);
    if (!isNaN(value) && value <= 4.5) {
      setOverallGPA(value);
    ...
    <div className="signup3-container">
      ...
      <form className="signup3-form">
        <TextField
          ...
          label="전체 학기 평점"
          value={overallGPA}
          onChange={handleOverallGPAChange}
          fullWidth
          variant="outlined"
        ...
        <FormControl fullWidth sx={{ mb: 3 }}>
          ...
          <Select value={incomeBracket} onChange={handleIncomeBracketChange}>
        ...
        <Modal open={modalOpen} onClose={() => setModalOpen(false)}>
          <div style={{ padding: '20px', backgroundColor: 'white', borderRadius: '8px', margin: 'auto' }}>
